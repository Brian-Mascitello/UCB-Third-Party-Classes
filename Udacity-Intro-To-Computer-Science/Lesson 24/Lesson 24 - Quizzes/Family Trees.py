...
def ancestors(genealogy, person):
    ...
    if person in genealogy:
        append_parents(genealogy, person, ancestors_list)
        for relative in ancestors_list:
            if relative in genealogy:
                append_parents(genealogy, relative, ancestors_list)
    return ancestors_list


def append_parents(genealogy, person, ancestors_list):
